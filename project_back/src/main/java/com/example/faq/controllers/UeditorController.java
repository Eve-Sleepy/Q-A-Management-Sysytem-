package com.example.faq.controllers;// package com.example.faq.controllers;
//
//
...
//
// 	public @ResponseBody Object ueditorConfig(HttpServletRequest request, HttpServletResponse response) throws IOException, JSONException {
...
// 			s = callback + "(" + new JSONObject(new ActionEnter(request, rootPath,saveRootPath).exec()) + ")";

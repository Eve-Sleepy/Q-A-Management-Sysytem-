        ...
        <ul >
            <li v-for="document in documentList.arr" class="documentarea" @click='to_detail(document.docId)'>
                ...
                <div class="icon_btn_div" >
                    <div type="" class="btn icon_edit_btn" v-if="showEdit||parseInt(idd) === document.author.id"  @click.stop="to_edit(document.docId)"><img class="icon_edit" src="../../build/img/icon_edit@2x.png">
                    </div>
                </div>

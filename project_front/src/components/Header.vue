        ...
        <nav class="headerview">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li>
                            <el-popover
                                    ...
                                    width="auto"
                                    trigger="hover">
                                <el-button class="btn_new_sth" type="text" @click="centerDialogVisible = true">新建产品
                                </el-button>
                                <router-link to="/content/create">
                                    <el-button class="btn_new_sth" type="text">
                                        新建文档
                                    </el-button>
                                </router-link>
                        ...
                        <li class="dropdown" :title="username">
                            <a href="#" class="username dropdown-toggle" data-toggle="dropdown" role="button"
                               aria-haspopup="true" aria-expanded="false">
                                <el-badge is-dot :hidden="notCheckedMsg === 0"><img class="icon_user"
                                                                                    src="../../build/img/icon_user@2x.png">
                                </el-badge>
                            ...
                            <ul class="dropdown-menu" aria-labelledby="dropdownMenu1">
                                ...
                                <li><a class="person" href="#" @click.prevent="changePwdDialogVisible = true">修改密码</a>
                                </li>
            ...
            <el-dialog
                ...
                <div class="color_input">
                    <span>主题色：</span>
                    <el-color-picker size="medium" v-model="product.color"
